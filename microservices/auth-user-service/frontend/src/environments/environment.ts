...
export const environment = {
  ...
  // URLs des services (via Gateway pour intégration microservices)
  authServiceUrl: 'http://localhost:8080/auth-user-service',
  apiUrl: 'http://localhost:8080/auth-user-service/api',
  ...
  upload: {
    ...
    uploadUrl: 'http://localhost:8080/auth-user-service/api/upload'
  },
  ...
  // URLs externes
  externalUrls: {
    documentation: 'http://localhost:8080/auth-user-service/swagger-ui/index.html',
